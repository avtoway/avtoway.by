...
const a: Record<string, Icon> = {
  home: p => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" fill="none" {...p}>
  ...
  handshake: p => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" fill="none" {...p}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.33 1.222a1.5 1.5 0 00-2.66 0L5.013 5.56 1.25 4.586a1.5 1.5 0 00-1.633 2.398l2.7 2.898-.6 3.054a1.5 1.5 0 002.176 1.583L6.5 13.2l1.806 1.108a1.5 1.5 0 002.389-.808l.583-2.164 2.583-.86a1.5 1.5 0 00.787-2.016l-1.974-4.56z" />
    </svg>
  ),
  users: p => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" fill="none" {...p}>
